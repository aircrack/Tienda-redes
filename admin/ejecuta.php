<?php 
	...
	if($_POST['Caso']=="Modificar"){
		mysql_query("update productos set Descripcion='".$_POST['Nombre']."' where Id=".$_POST['Id']);
		mysql_query("update productos set Categoria='".$_POST['Descripcion']."' where Id=".$_POST['Id']);
